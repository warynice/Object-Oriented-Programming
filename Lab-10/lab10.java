	...
	public static void main(String args[]) {
		...
		rightButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if(rightThreadRunning == false) {
					rightThread.myresume();
					rightThreadRunning = true;
				}
			}
		});
		...
		scaleUpButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if(scaleUpThreadRunning == false) {
					scaleUpThread.myresume();
					scaleUpThreadRunning = true;
				}
			}
		});
		...
		scaleDownButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if(scaleDownThreadRunning == false) {
					scaleDownThread.myresume();
					scaleDownThreadRunning = true;
				}
			}
		});

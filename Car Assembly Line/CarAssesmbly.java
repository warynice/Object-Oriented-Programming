...
class Car {
	...
	// Accessor Methods
	public boolean isEngineFitted() {
		return engineFitted;
	}
	public boolean isTyreFitted() {
		return tyreFitted;
	}
	public boolean isLightSystemFitted() {
		return lightSystemFitted;
	}
	public boolean iCarReady() {
		return engineFitted && tyreFitted && lightSystemFitted;
	}
	...
	public void fitLightSystem() {
		lightSystemFitted = true;
	}	
} // End of Class Car
...
class Slot {
	...
	// Accessor Methods
	public JLabel getSlotHeadingLabel() {
		return this.slotHeadingLabel;
	}
	public JButton getEngineButton() {
		return this.engineButton;
	}
	public JButton getTyreButton() {
		return this.tyreButton;
	}
	public JButton getLightSystemButton() {
		return this.lightSystemButton;
	}
	public Car getCar() {
		return this.car;
	}
...
class AssemblyLine {
	...
	public synchronized boolean isInitialized()	{
		return assemblyLineInitialized;
	}
	public synchronized boolean isStarted() {
		return assemblyLineStarted;
	}

	// Methods to Initialize and Start an Assembly Line
	public void initialize() {
		assemblyLineInitialized = true;
	}
	public void start() {
		assemblyLineStarted = true;
	}
			...
			while(no_of_CarsAdded < 30) {
				try {
					...
					if(executionTime < 2000) {
						Thread.sleep(2000 - executionTime);
						executionTime = (System.currentTimeMillis() - x);
					}
...
class TyreThread extends Thread {
	...
	private JTextArea threadsTextArea;
	private JButton	tyreThreadButton;
	private int	no_of_CarsAdded;
...
class LightThread extends Thread {
	private AssemblyLine assemblyLine;
	private JTextArea threadsTextArea;
	private JButton	lightThreadButton;
	private int	no_of_CarsAdded;
	private int	no_of_Iterations;
...
class RemoveThread extends Thread {
	private AssemblyLine assemblyLine;
	private JTextArea threadsTextArea;
	private JButton	removeThreadButton;
	private int	no_of_CarsAdded;
	private int	no_of_Iterations;
